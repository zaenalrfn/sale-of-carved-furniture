                                        ...
                                        <div class="flex items-center space-x-3 w-full md:w-auto">
                                            ...
                                            <form id="filterForm" method="GET"
                                                ...
                                                <div id="filterDropdown"
                                                    class="z-10 hidden overflow-y-auto h-24 w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <ul class="space-y-2 text-sm">
                                                        ...
                                                        <li class="flex items-center">
                                                            <input id="category-all" name="categories[]"
                                                    ...
                                                    <div class="mt-4">
                                                        <button type="submit"
                                                            class="w-full px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded hover:bg-primary-700">
                                                            Apply Filters
                                                        </button>
                                                    </div>
                                                </div>
