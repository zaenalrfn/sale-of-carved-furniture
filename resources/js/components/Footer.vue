    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      >
        <div class="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
          <div
            class="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3"
          >
            <div>
              <h6
      ...
      <div class="py-6 md:py-8">
        ...
        >
          <a href="#" title="" class="block text-2xl font-bold"> Coba Shop </a>

          <ul
            class="flex flex-wrap items-center gap-4 text-sm text-gray-900 dark:text-white xl:justify-center"
          >
            <li>
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">
            © 2024 <a href="#" class="hover:underline">Coba Shop</a>, Inc. All
            rights reserved.
          </p>
        </div>
      </div>
